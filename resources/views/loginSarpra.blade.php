...
@section('content')
    ...
    <form action="{{route('loginSarpraProcess')}}" class="flex flex-col mx-auto gap-8 justify-center w-[30%]" method="post">
        @csrf
        <div class="flex flex-col gap-4 w-[100%]">
            <div class="flex flex-col gap-2">
                <label for="username" class="text-white">Username</label>
                <input type="text" name="username" id="username" class="p-3 bg-stone-50 rounded-xl">
            </div>
            <div class="flex flex-col gap-2">
